...
npm run dev
```
(fill in your own MongoDB URI, JWT secret, and Gmail app password in .env)
...
- Tournament.stages exists as a schema placeholder for future multi-stage tournaments (group stage to knockout) but isn't implemented yet
